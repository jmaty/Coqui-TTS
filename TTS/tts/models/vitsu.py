...
from TTS.tts.layers.vitsu.networks import PosteriorEncoder, ResidualCouplingBlocks, TextEncoder
from TTS.tts.layers.vitsu.stochastic_duration_predictor import StochasticDurationPredictor
...
class VitsuArgs(Coqpit):
    ...
    Args:
        ...
        upsample_factors_decoder (List[int]):
            List of uplsample factors for the upsampling layers. Defaults to `[8, 8, 4]`.
...
class Vitsu(BaseTTS):
    ...
    Examples:
        >>> from TTS.tts.configs.vitsu_config import VitsuConfig
    ...
    def __init__(
        ...
        if self.args.init_discriminator:
            self.disc = VitsuDiscriminator(use_spectral_norm=self.args.use_spectral_norm_disriminator)
